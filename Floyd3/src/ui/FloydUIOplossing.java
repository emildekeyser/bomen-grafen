...
import domain.WeightedGraphOplossing;
public class FloydUIOplossing {
	static final double infty = WeightedGraphOplossing.infty;
	public static void main(String[] args) {
		...
		WeightedGraphOplossing g = new WeightedGraphOplossing(matrix);
